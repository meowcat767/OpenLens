...
│   ├── scraper/
│   │   ├── WebScraper.java         # Scrapes web pages
│   │   └── ScraperMain.java        # Entry point for scraping
│   ├── export/
│   │   └── StaticExporter.java     # Exports DB to JSON
│   └── config/
...
│   └── search-data.json            # Generated by exporter
